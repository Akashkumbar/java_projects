<%@ page import="java.util.*, com.BankProject.DAO.TransactionDAO, com.BankProject.DAO.TransactionDAOImpl, com.BankProject.dto.Transaction, com.BankProject.dto.Customer, com.BankProject.DAO.CustomerDAO, com.BankProject.DAO.CustomerDAOImpl" %>
...
<%
    ...
    ArrayList<Customer> lst = (ArrayList<Customer>) cdao.getCustomer();
            ...
            <table>
                ...
                %>
                    <tr>
                        ...
                        <input class="delete-btn" type="submit" value="Delete"></form>
                        </td>
                    </tr>
                <% } %>
                </tbody>
